...
exports.getParams = async () => {
  ...
  return new Promise((resolve, reject) => {
    if (!params) {
      if (process.env.WELL_KNOWN && process.env.CLIENT_KEY && process.env.CLIENT_SECRET && process.env.DB_USER &&
        process.env.DB_PWD && process.env.DB_CS) {
        params = {};
        ...
        ssm.getParameters(p).promise()
          .then(response => {
            ...
            if (params.WELL_KNOWN === undefined || params.CLIENT_KEY === undefined ||
              params.CLIENT_SECRET === undefined || params.DB_USER === undefined || params.DB_PWD === undefined ||
              params.DB_CS === undefined) {
