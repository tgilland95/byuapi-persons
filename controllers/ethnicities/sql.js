...
exports.sql = {
  getEthnicities: `
    select a.byu_id                                                                            as "byu_id",
           ...
           to_char(eth.date_time_updated at time zone 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.FF3"Z"') as "date_time_updated", 
           eth.updated_by_id                                                                   as "updated_by_id",
           ii.identity_name                                                                    as "updated_by_name",
           to_char(eth.date_time_created at time zone 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.FF3"Z"') as "date_time_created", 
  ...
  getEthnicity: `
    ...
    from   iam.person a 
           left join iam.ethnicity eth 
                  on a.byu_id = eth.byu_id 
                     and eth.ethnicity_code = :ETHNICITY_CODE 
           left join iam.identity ii 
                  on eth.updated_by_id = ii.byu_id 
           left join iam.identity iii 
                  on eth.created_by_id = iii.byu_id 
